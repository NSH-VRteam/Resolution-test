...
function pano2vrSkin(player,base) {
	...
	player.addVariable('Potrait_view', 2, false, { ignoreInState: 1  });
	player.addVariable('Fullscreen', 2, false, { ignoreInState: 0  });
	var me=this;
	var skin=this;
	var flag=false;
	...
	this.addSkin=function() {
		...
		me._variable_Potrait_view = {};
		me._variable_Potrait_view.ggCurrentLogicState = -1;
		me._variable_Potrait_view.logicBlock = function() {
			var newLogicState_Potrait_view;
			if (
				((player.getViewerSize(true).width < 1200)) && 
				((player.getViewerSize(true).height > 1200)) && 
				((player.getIsMobile() == true))
			)
			{
				newLogicState_Potrait_view = 0;
			}
			else if (
				((player.getViewerSize(true).width > 1200)) && 
				((player.getViewerSize(true).height < 1200)) && 
			...
			{
				newLogicState_Potrait_view = 1;
			}
			else {
				newLogicState_Potrait_view = -1;
			}
			if (me._variable_Potrait_view.ggCurrentLogicState != newLogicState_Potrait_view) {
				me._variable_Potrait_view.ggCurrentLogicState = newLogicState_Potrait_view;
				if (me._variable_Potrait_view.ggCurrentLogicState == 0) {
					player.setVariableValue('Potrait_view', true);
				}
				else if (me._variable_Potrait_view.ggCurrentLogicState == 1) {
					player.setVariableValue('Potrait_view', false);
				}
				else {
					player.setVariableValue('Potrait_view', false);
				}
		...
		me._minimap_bg.appendChild(me._rectangle_1);
		...
		me._minimap_bg.appendChild(me._rectangle_1_1);
		...
		me._right_top_corner_panel.appendChild(me._blur_bg);
		...
		me._fullscreen_off_b.onclick=function (e) {
			...
			player.setVariableValue('Fullscreen', !player.getVariableValue('Fullscreen'));
		}
		...
		hs+='cursor : pointer;';
		hs+='height : 30px;';
		hs+='left : calc(50% - ((40px + 0px) / 2) - 934px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((30px + 0px) / 2) + 520px);';
		hs+='visibility : inherit;';
		hs+='width : 40px;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		me._view_o_b.appendChild(me._v_bg_1);
		...
		me._view_o_h.ggUpdateText=function() {
			var params = [];
			var hs = player._("View Menu", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._mouse_qg.logicBlock_size = function() {
			...
			)
			{
				...
				((player.getVariableValue('Fullscreen') == false))
			)
			{
				newLogicStateSize = 1;
			}
			...
			if (me._mouse_qg.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._mouse_qg.ggCurrentLogicStateSize == 0) {
					me._mouse_qg.style.width='72.92%';
					me._mouse_qg.style.height='64.81%';
					me._mouse_qg.style.left = 'calc(50% - (72.92% / 2))';
					me._mouse_qg.style.top = 'calc(50% - (64.81% / 2))';
					skin.updateSize(me._mouse_qg);
				}
				else if (me._mouse_qg.ggCurrentLogicStateSize == 1) {
					me._mouse_qg.style.width='72.92%';
					me._mouse_qg.style.height='75%';
					me._mouse_qg.style.left = 'calc(50% - (72.92% / 2))';
					me._mouse_qg.style.top = 'calc(50% - (75% / 2))';
					skin.updateSize(me._mouse_qg);
				}
				else if (me._mouse_qg.ggCurrentLogicStateSize == 2) {
					me._mouse_qg.style.width='72.92%';
					me._mouse_qg.style.height='35%';
					me._mouse_qg.style.left = 'calc(50% - (72.92% / 2))';
					me._mouse_qg.style.top = 'calc(50% - (35% / 2))';
					skin.updateSize(me._mouse_qg);
				}
				else if (me._mouse_qg.ggCurrentLogicStateSize == 3) {
					me._mouse_qg.style.width='72.92%';
					me._mouse_qg.style.height='75%';
					me._mouse_qg.style.left = 'calc(50% - (72.92% / 2))';
					me._mouse_qg.style.top = 'calc(50% - (75% / 2))';
					...
					me._mouse_qg.style.width='72.92%';
					me._mouse_qg.style.height='80%';
					me._mouse_qg.style.left = 'calc(50% - (72.92% / 2))';
					me._mouse_qg.style.top = 'calc(50% - (80% / 2))';
					skin.updateSize(me._mouse_qg);
				}
			}
		}
		...
		hs ='';
		hs+='height : 64.8148%;';
		hs+='left : calc(50% - ((72.9167% + 0px) / 2) + 0%);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((64.8148% + 0px) / 2) + 0%);';
		hs+='visibility : hidden;';
		hs+='width : 72.9167%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs+='cursor : pointer;';
		hs+='height : 3.24074%;';
		hs+='left : calc(50% - ((5.20833% + 0px) / 2) + 33.3333%);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((3.24074% + 0px) / 2) - 29.6296%);';
		hs+='visibility : inherit;';
		hs+='width : 5.20833%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs+='cursor : pointer;';
		hs+='height : 5.55556%;';
		hs+='left : calc(50% - ((2.08333% + 0px) / 2) - 32.8125%);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((5.55556% + 0px) / 2) + 0%);';
		hs+='visibility : inherit;';
		hs+='width : 2.08333%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs+='border : 0px solid #000000;';
		hs+='height : 122.222%;';
		hs+='left : calc(50% - ((161.667% + 0px) / 2) + 0%);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((122.222% + 0px) / 2) + 0%);';
		hs+='visibility : inherit;';
		hs+='width : 161.667%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs ='';
		hs+='height : 58.61%;';
		hs+='left : calc(50% - ((62.5% + 0px) / 2) + 0%);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((58.61% + 0px) / 2) + 0%);';
		hs+='visibility : inherit;';
		hs+='width : 62.5%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs+='cursor : pointer;';
		hs+='height : 2.77778%;';
		hs+='left : calc(50% - ((1.5625% + 0px) / 2) + 0%);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((2.77778% + 0px) / 2) + 23.1481%);';
		hs+='visibility : inherit;';
		hs+='width : 1.5625%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs+='z-index: -2;';
		hs+='height : 200%;';
		hs+='left : calc(50% - ((200% + 0px) / 2) + 0%);';
		hs+='opacity : 0;';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((200% + 0px) / 2) + 0%);';
		hs+='visibility : hidden;';
		hs+='width : 200%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs+='border : 0px solid #000000;';
		hs+='height : 93.3333%;';
		hs+='left : calc(50% - ((75% + 0px) / 2) + 8.33333%);';
		hs+='overflow : hidden;';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((93.3333% + 0px) / 2) + 0%);';
		hs+='visibility : inherit;';
		hs+='width : 75%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs+='cursor : pointer;';
		hs+='height : 3.88889%;';
		hs+='left : calc(50% - ((8.33333% + 0px) / 2) + 45%);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((3.88889% + 0px) / 2) - 46.8889%);';
		hs+='visibility : inherit;';
		hs+='width : 8.33333%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs+='cursor : pointer;';
		hs+='height : 3.88889%;';
		hs+='left : calc(50% - ((16.6667% + 0px) / 2) - 35%);';
		hs+='opacity : 0.5;';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((3.88889% + 0px) / 2) - 5.55556%);';
		hs+='visibility : inherit;';
		hs+='width : 16.6667%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs+='opacity : 0.5;';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((3.88889% + 0px) / 2) + 0%);';
		hs+='visibility : inherit;';
		hs+='width : 16.6667%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs+='cursor : pointer;';
		hs+='height : 3.89%;';
		hs+='left : calc(50% - ((16.67% + 0px) / 2) - 35%);';
		hs+='opacity : 0.5;';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((3.89% + 0px) / 2) + 5.56%);';
		hs+='visibility : inherit;';
		hs+='width : 16.67%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs+='border : 0px solid #000000;';
		hs+='height : 122.22%;';
		hs+='left : calc(50% - ((161.67% + 0px) / 2) + 0%);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((122.22% + 0px) / 2) + 0%);';
		hs+='visibility : inherit;';
		hs+='width : 161.67%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		player.addListener('configloaded', function(event) {
			...
			me._variable_Potrait_view.logicBlock();
			for (var i=0; i < me._mini_map.ggMarkerInstances.length; i++) {
		...
		player.addListener('varchanged_Fullscreen', function(event) {
			me._mouse_qg.logicBlock_size();
		});
		...
		player.addListener('varchanged_Potrait_view', function(event) {
			me._mouse_qg.logicBlock_size();
		});
